		...
		<div className="bg-card-background rounded p-4">
			...
			<form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
				<div className="flex flex-col">
					...
					<input
						type="text"
						className="border-secondary-text text-primary-text rounded border p-1 outline-none"
				...
				<div className="flex flex-col">
					...
					<textarea
						...
						className="border-secondary-text text-primary-text resize-none rounded border p-1 outline-none"
						rows={5}
						maxLength={100}
					/>
				</div>
				<button
					type="submit"
					className="border-hover text-hover hover:bg-hover hover:text-primary-text rounded border py-2 transition-all duration-200 ease-in-out hover:cursor-pointer"
				>
					Send Email
				</button>
			</form>
